        ...
        implements Rule<FilterNode>
{
    ...
    public Result apply(FilterNode filterNode, Captures captures, Context context)
    {
        ...
        for (RowExpression conjunct : originalConjuncts) {
            Optional<PushdownResult> result = tryPushdown(conjunct, eligible, sourceOutputs);
            if (result.isPresent()) {
    ...
    private Optional<PushdownResult> tryPushdown(RowExpression conjunct, EligibleAggregate eligible, Set<VariableReferenceExpression> sourceOutputs)
    {
